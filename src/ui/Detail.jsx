...
import { CssBaseline, Typography, Container, Grid, Paper, Box, TextField, GridList, GridListTile, GridListTileBar, Button, ListSubheader, MenuItem, FormControl, Select, InputLabel, TableBody, Table, TableCell, TableContainer, TableRow, TableHead } from '@material-ui/core/';
...
const sizeTableText = `サイズ    |着丈(CB)      |肩巾        |身巾       |袖丈
                ...
                <Grid container spacing={1}>
                    <Grid item xs={6}>
                        <Box className={classes.orange} padding={3}>
                            ...
                            ></DropzoneArea>
                            <TextField id="outlined-basic" label="モデル情報" variant="standard" fullWidth />
                            <TextField id="outlined-basic" label="ALT 文言" variant="standard" fullWidth />
                        </Box>
                        {/* image Tile  */}
                        <Box>
                        ...
                        <Box>
                            <TextField multiline rowsMax={5} fullWidth variant="filled" value={sizeTableText}></TextField>
                            <Box className={classes.verticalTiny}></Box>
                            <Button variant="contained" color="primary" fullWidth><Typography variant="text"> ↓サイズテーブル生成 </Typography></Button>
                            <Box className={classes.verticalTiny}></Box>
                            <TableContainer component={Paper}>
                                <Table className={classes.table} size="small" aria-label="a dense table">
                                    <TableHead>
                                        <TableRow>
                                            {sizeHeader.map((header) => (
